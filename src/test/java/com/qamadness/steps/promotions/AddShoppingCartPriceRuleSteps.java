package com.qamadness.steps.promotions;


import com.qamadness.pages.promotions.AddShoppingCartPriceRule;
...
public class AddShoppingCartPriceRuleSteps extends ScenarioSteps{
    ...
    @Step
    public void clear_global_search(){addShoppingCartPriceRule.clearGlobalSearch();}
}
